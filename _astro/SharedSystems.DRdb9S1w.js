import {F as Re, v as Be, l as X, M as v, G as Ue, x as Ae, E as u, e as R, y as Q, S as Ie, z as b, H as Ee, I as L, R as B, J as Z, K as ee, L as De, u as m, b as f, i as w, w as te, N as W, O as Fe, c as z, B as y, Q as G, V as Oe, j as V, W as He, X as j, k as re, a as Le, Y as C, C as T, Z as se, _ as ne, $ as ae, a0 as ie, a1 as We, P as ze, d as Ve, T as N, D as je, a2 as $, a3 as Ne, a4 as $e} from "./hoisted.D2QO1Zsw.js";
import {B as qe, c as Ke} from "./colorToUniform.ctgBpyc5.js";
...
const U = class oe {
    ...
    addToBatch(e, t) {
        if (this._activeBatch.name !== e.batcherName) {
            ...
            r || (r = this._activeBatches[e.batcherName] = oe.getBatcher(e.batcherName),
            r.begin()),
            this._activeBatch = r
        }
    ...
    buildEnd(e) {
        ...
        for (const r in t) {
            const n = t[r]
              , a = n.geometry;
            a.indexBuffer.setDataWithSize(n.indexBuffer, n.indexSize, !0),
            a.buffers[0].setDataWithSize(n.attributeBuffer.float32View, n.attributeSize, !1)
        }
    }
    upload(e) {
        ...
        for (const r in t) {
            const n = t[r]
              , a = n.geometry;
            n.dirty && (n.dirty = !1,
            a.buffers[0].update(n.attributeSize * 4))
        }
    }
    execute(e) {
...
U._availableBatchers = Object.create(null);
let le = U;
...
function Qe(s, e) {
    ...
    const n = e.renderPipes ? e : e.batch.renderer
      , a = n.renderPipes;
    a.batch.buildStart(r),
    a.blendMode.buildStart(),
    a.colorMask.buildStart(),
    t.sortableChildren && t.sortChildren(),
    de(t, r, n, !0),
    a.batch.buildEnd(r),
    a.blendMode.buildEnd(r)
}
function M(s, e, t) {
    const r = t.renderPipes ? t : t.batch.renderer;
    s.globalDisplayStatus < 7 || !s.includeInBuild || (s.sortableChildren && s.sortChildren(),
    s.isSimple ? Ze(s, e, r) : de(s, e, r, !1))
}
function Ze(s, e, t) {
    if (s.renderPipeId) {
        const r = s
          , {renderPipes: n, renderableGC: a} = t;
        n.blendMode.setBlendMode(r, s.groupBlendMode, e),
        n[r.renderPipeId].addRenderable(r, e),
        a.addRenderable(r, e),
        r.didViewUpdate = !1
    }
    if (!s.renderGroup) {
...
function de(s, e, t, r) {
    ...
    if (!r && s.renderGroup)
        ...
        const i = s
          , l = i.renderPipeId;
        l && (n.blendMode.setBlendMode(i, i.groupBlendMode, e),
        n[l].addRenderable(i, e),
        a.addRenderable(i, e),
        i.didViewUpdate = !1);
        const o = s.children;
        if (o.length)
...
class ue {
    ...
    push(e, t, r) {
        ...
        if (n.renderPipes.batch.break(r),
        r.add({
        ...
        if (e.action === "pushMaskBegin") {
            ...
            r) {
                ...
                const i = t.renderTarget.renderTarget.colorTexture.source
                  , l = L.getOptimalTexture(a.width, a.height, i._resolution, i.antialias);
                t.renderTarget.push(l, !0),
                ...
                const o = n.sprite;
                o.texture = l,
                o.worldTransform.tx = a.minX,
                o.worldTransform.ty = a.minY,
            ...
            r && (t.type === B.WEBGL && t.renderTarget.finishRenderPass(),
            t.renderTarget.pop(),
            ...
            r && L.returnTexture(n.filterTexture),
            b.return(n.filterEffect)
        }
    }
    destroy() {
        this._renderer = null,
...
class he {
    ...
    pop(e, t, r) {
        ...
        a.renderPipes.blendMode.setBlendMode(n.mask, "none", r),
        r.add({
            renderPipeId: "stencilMask",
            action: "popMaskBegin",
            inverse: t._maskOptions.inverse,
    ...
    execute(e) {
        ...
        r.stencil.setStencilMode(f.RENDERING_MASK_ADD, a),
        a++,
        r.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(f.MASK_ACTIVE, a),
        r.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (r.colorMask.setMask(0),
        a !== 0 ? r.stencil.setStencilMode(f.RENDERING_MASK_REMOVE, a) : (r.renderTarget.clear(null, w.STENCIL),
        r.stencil.setStencilMode(f.DISABLED, a)),
        a--) : e.action === "popMaskEnd" && (e.inverse ? r.stencil.setStencilMode(f.INVERSE_MASK_ACTIVE, a) : r.stencil.setStencilMode(f.MASK_ACTIVE, a),
...
function wt(s, e) {
    for (const t in s.attributes) {
        const r = s.attributes[t]
          , n = e[t];
        n ? (r.format ?? (r.format = n.format),
        r.offset ?? (r.offset = n.offset),
        r.instance ?? (r.instance = n.instance)) : te(`Attribute ${t} is not present in the shader, but is present in the geometry. Unable to infer attribute details.`)
    }
    rt(s)
}
function rt(s) {
    ...
    for (const a in t) {
        ...
        i.start ?? (i.start = n[i.buffer.uid]),
        n[i.buffer.uid] += W(i.format).stride
    }
}
const _ = [];
_[f.NONE] = void 0;
...
class Gt {
    ...
    _initUniformGroup(e) {
        ...
        if (!r) {
            const n = Object.keys(e.uniformStructures).map(l => e.uniformStructures[l])
              , a = this._adaptor.createUboElements(n)
...
function Rt(s, e, t, r) {
    ...
    for (let l = 0; l < s.length; l++) {
        ...
        for (let p = 0; p < k.length; p++)
            if (k[p].test(o.data)) {
                h = o.offset / 4,
                n.push(`name = "${d}";`, `offset += ${h - a};`, k[p][e] || k[p].ubo),
                c = !0;
                break
            }
        if (!c)
...
class Ut {
    constructor(e) {
        this.rootViewPort = new G,
        this.viewport = new G,
        this.onRenderTargetChange = new Oe("onRenderTargetChange"),
    ...
    renderStart({target: e, clear: t, clearColor: r, frame: n}) {
        this._renderTargetStack.length = 0,
        this.push(e, t, r, n),
        this.rootViewPort.copyFrom(this.viewport),
        this.rootRenderTarget = this.renderTarget,
        this.renderingToScreen = at(this.rootRenderTarget)
    }
    postrender() {
    ...
    bind(e, t=!0, r, n) {
        ...
        (a.pixelWidth !== l.width || a.pixelHeight !== l.height) && (this.adaptor.resizeGpuRenderTarget(a),
        l.width = a.pixelWidth,
        l.height = a.pixelHeight);
        const o = a.colorTexture
          , d = this.viewport
          , c = o.pixelWidth
          , h = o.pixelHeight;
        if (!n && e instanceof m && (n = e.frame),
        n) {
            const p = o._resolution;
            d.x = n.x * p + .5 | 0,
            d.y = n.y * p + .5 | 0,
            d.width = n.width * p + .5 | 0,
            d.height = n.height * p + .5 | 0
        } else
            d.x = 0,
            d.y = 0,
            d.width = c,
            d.height = h;
        return nt(this.projectionMatrix, 0, 0, d.width / o.resolution, d.height / o.resolution, !a.isRoot),
    ...
    copyToTexture(e, t, r, n, a) {
        ...
        return n.width = Math.min(n.width, i - r.x),
        n.height = Math.min(n.height, l - r.y),
        this.adaptor.copyToTexture(e, t, r, n, a)
    }
    ensureDepthStencil() {
    ...
    _initRenderTarget(e) {
        let t = null;
        return V.test(e) && (e = He(e).source),
        e instanceof j ? t = e : e instanceof re && (t = new j({
            colorTextures: [e]
        }),
        V.test(e.source.resource) && (t.isRoot = !0),
        e.once("destroy", () => {
            t.destroy(),
...
function lt(s) {
    ...
    if (s.renderGroupParent) {
        ...
        s.worldColor = ge(e.groupColor, r.worldColor),
...
function be(s, e, t) {
    ...
    const n = s.parent;
    if (n && !n.renderGroup ? (t = t | s._updateFlags,
    s.relativeGroupTransform.appendFrom(r, n.relativeGroupTransform),
    t & K && Y(s, n, t)) : (t = s._updateFlags,
...
function Y(s, e, t) {
    if (t & se) {
        s.groupColor = ge(s.localColor, e.groupColor);
        let r = s.localAlpha * e.groupAlpha;
        r = r < 0 ? 0 : r > 1 ? 1 : r,
        s.groupAlpha = r,
        s.groupColorAlpha = s.groupColor + ((r * 255 | 0) << 24)
    }
    t & ne && (s.groupBlendMode = s.localBlendMode === "inherit" ? e.groupBlendMode : s.localBlendMode),
    t & ae && (s.globalDisplayStatus = s.localDisplayStatus & e.globalDisplayStatus),
    s._updateFlags = 0
}
function dt(s, e) {
    ...
    for (let a = 0; a < r; a++) {
        const i = t[a];
        if (n = e[i.renderPipeId].validateRenderable(i),
        n)
            break
    }
    return s.structureDidChange = n,
    n
}
const ut = new v;
class xe {
    ...
    render({container: e, transform: t}) {
        ...
        const a = this._renderer
          , i = ve(e.renderGroup, []);
        let l = ut;
        t && (l = l.copyFrom(e.renderGroup.localTransform),
        ...
        for (let d = 0; d < i.length; d++) {
            ...
            c.structureDidChange ? A(c.childrenRenderablesToUpdate.list, 0) : dt(c, o),
            _e(c),
            c.structureDidChange ? (c.structureDidChange = !1,
            Qe(c, a)) : ct(c),
            c.childrenRenderablesToUpdate.index = 0,
            a.renderPipes.batch.upload(c.instructionSet)
        }
...
class Te {
    ...
    _beginAdvancedBlendMode(e) {
        ...
        this._renderableList = n.renderables,
        e.add(n)
    }
...
const S = {
  ...
  , E = class Me {
    ...
    canvas(e) {
        ...
        const n = r.textureGenerator.generateTexture(e)
          , a = r.texture.generateCanvas(n);
        return n.destroy(),
        a
    }
    pixels(e) {
        ...
        const t = e.target
          , r = this._renderer
          , n = t instanceof m ? t : r.textureGenerator.generateTexture(e)
          , a = r.texture.getPixels(n);
        return t instanceof T && n.destroy(),
        a
    }
    texture(e) {
    ...
    log(e) {
        ...
        const a = ["font-size: 1px;", `padding: ${t}px 300px;`, `background: url(${n}) no-repeat;`, "background-size: contain;"].join(" ");
        console.log("%c ", a)
    }
    destroy() {
        this._renderer = null
...
class Ce {
    ...
    generateTexture(e) {
        ...
        const i = e.frame?.copyTo(pt) || We(n, mt).rectangle;
...
class Pe {
    ...
    bind({size: e, projectionMatrix: t, worldTransformMatrix: r, worldColor: n, offset: a}) {
        const i = this._renderer.renderTarget.renderTarget
          , l = this._stackIndex ? this._globalUniformDataStack[this._stackIndex - 1] : {
            projectionData: i,
        ...
        Ke(o.worldColor, c.uWorldColorAlpha, 0),
        d.update();
        let h;
        this._renderer.renderPipes.uniformBatch ? h = this._renderer.renderPipes.uniformBatch.getUniformBindGroup(d, !1) : (h = this._bindGroupPool.pop() || new Ve,
    ...
    pop() {
        ...
        this._renderer.type === B.WEBGL && this._currentGlobalUniformData.bindGroup.resources[0].update()
    }
    get bindGroup() {
...
class Se {
    ...
    destroy() {
        N.system.remove(this._update, this),
...
function _t(s) {
    if (!J) {
        if (je.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
            const e = [`%c  %c  %c  %c  %c PixiJS %c v${$} (${s}) http://www.pixijs.com/
...
class F {
    ...
    init(e) {
        if (e.hello) {
            ...
            this._renderer.type === B.WEBGL && (t += ` ${this._renderer.context.webGLVersion}`),
            _t(t)
        }
    }
}
...
const O = class we {
    ...
    addRenderable(e, t) {
        this.enabled && (e._lastUsed = this._now,
        e._lastInstructionTick === -1 && (this._managedRenderables.push(e),
        e.once("destroyed", this._removeRenderable, this)),
        e._lastInstructionTick = t.tick)
    }
    run() {
        const e = performance.now()
        ...
        for (let a = 0; a < t.length; a++) {
            ...
            const o = (i.renderGroup ?? i.parentRenderGroup)?.instructionSet?.tick ?? -1;
            i._lastInstructionTick !== o && e - i._lastUsed > this.maxUnusedTime ? (i.destroyed || r[i.renderPipeId].destroyRenderable(i),
            i._lastInstructionTick = -1,
            n++,
            i.off("destroyed", this._removeRenderable, this)) : t[a - n] = i
        }
        t.length = t.length - n
    }
    destroy() {
...
let kt = H;
const It = [ht, Pe, F, Ne, xe, kt, Ce, ft, $e, yt, Se]
  , Et = [Te, le, ye, me, ue, he, ce, fe];
export {At as B, _ as G, Ut as R, It as S, Gt as U, Et as a, st as b, Rt as c, k as d, wt as e, St as f, Pt as t, Bt as u};
