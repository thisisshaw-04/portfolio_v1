import {P as m, r as J, E as w, T as L, U as Q, a as ee, w as y, e as z, C as Z} from "./hoisted.D2QO1Zsw.js";
import "./webworkerAll.DPLUA6eM.js";
import "./colorToUniform.ctgBpyc5.js";
class M {
    constructor(e) {
        this.bubbles = !0,
        this.cancelBubble = !0,
        ...
        this.eventPhase = M.prototype.NONE,
...
function W(o) {
    ...
    !o && typeof navigator < "u" ? e = {
        userAgent: navigator.userAgent,
        platform: navigator.platform,
        maxTouchPoints: navigator.maxTouchPoints || 0
    } : typeof o == "string" ? e.userAgent = o : o && o.userAgent && (e = {
...
const ie = W.default ?? W
  , ne = ie(globalThis.navigator)
  , se = 9
  , I = 100
  , oe = 0
  , re = 0
...
class V {
    ...
    _updateAccessibleObjects(e) {
        if (!e.visible || !e.accessibleChildren)
            return;
        e.accessible && e.isInteractive() && (e._accessibleActive || this._addChild(e),
    ...
    postrender() {
        ...
        const {x: t, y: i, width: n, height: s} = this._renderer.view.canvas.getBoundingClientRect()
          , {width: r, height: a, resolution: c} = this._renderer
          , p = n / r * c
          , h = s / a * c;
        let l = this._div;
        l.style.left = `${t}px`,
        ...
        for (let d = 0; d < this._children.length; d++) {
            const u = this._children[d];
            if (u._renderId !== this._renderId)
                u._accessibleActive = !1,
                J(this._children, d, 1),
                this._div.removeChild(u._accessibleDiv),
                this._pool.push(u._accessibleDiv),
                u._accessibleDiv = null,
                d--;
            else {
                l = u._accessibleDiv;
                let v = u.hitArea;
                const _ = u.worldTransform;
                u.hitArea ? (l.style.left = `${(_.tx + v.x * _.a) * p}px`,
                l.style.top = `${(_.ty + v.y * _.d) * h}px`,
                l.style.width = `${v.width * _.a * p}px`,
                l.style.height = `${v.height * _.d * h}px`) : (v = u.getBounds().rectangle,
                this._capHitArea(v),
                l.style.left = `${v.x * p}px`,
                l.style.top = `${v.y * h}px`,
                l.style.width = `${v.width * p}px`,
                l.style.height = `${v.height * h}px`,
                l.title !== u.accessibleTitle && u.accessibleTitle !== null && (l.title = u.accessibleTitle || ""),
                l.getAttribute("aria-label") !== u.accessibleHint && u.accessibleHint !== null && l.setAttribute("aria-label", u.accessibleHint || "")),
                (u.accessibleTitle !== l.title || u.tabIndex !== l.tabIndex) && (l.title = u.accessibleTitle || "",
                l.tabIndex = u.tabIndex,
                this.debug && this._updateDebugHTML(l))
            }
        }
        this._renderId++
    }
    ...
    _dispatchEvent(e, t) {
        const {container: i} = e.target
          ...
          , s = Object.assign(new M(n), {
            target: i
        });
        n.rootTarget = this._renderer.lastObjectRendered,
        t.forEach(r => n.dispatchEvent(s, r))
    }
    _onClick(e) {
...
class de {
    ...
    addTickerListener() {
        this._tickerAdded || !this.domElement || (L.system.add(this._tickerUpdate, this, Q.INTERACTION),
        this._tickerAdded = !0)
    }
    removeTickerListener() {
        this._tickerAdded && (L.system.remove(this._tickerUpdate, this),
        this._tickerAdded = !1)
    }
    pointerMoved() {
        this._didMove = !0
...
class D extends M {
    ...
    initMouseEvent(e, t, i, n, s, r, a, c, p, h, l, d, u, v, _) {
...
class ve {
    ...
    hitTest(e, t) {
        ...
        const n = this._isPointerMoveEvent && this.enableGlobalMoveEvents ? "hitTestMoveRecursive" : "hitTestRecursive"
          , s = this[n](this.rootTarget, this.rootTarget.eventMode, pe.set(e, t), this.hitTestFn, this.hitPruneFn);
        return s && s[0]
    }
    propagate(e, t) {
        if (!e.target)
    ...
    hitTestMoveRecursive(e, t, i, n, s, r=!1) {
        let a = !1;
        if (this._interactivePrune(e))
            return null;
        if ((e.eventMode === "dynamic" || t === "dynamic") && (E.pauseUpdate = !1),
        e.interactiveChildren && e.children) {
            const h = e.children;
            for (let l = h.length - 1; l >= 0; l--) {
                const d = h[l]
                  , u = this.hitTestMoveRecursive(d, this._isInteractive(t) ? t : d.eventMode, i, n, s, r || s(e, i));
                if (u) {
                    if (u.length > 0 && !u[u.length - 1].parent)
                        continue;
                    const v = e.isInteractive();
                    (u.length > 0 || v) && (v && this._allInteractiveElements.push(e),
                    u.push(e)),
                    this._hitElements.length === 0 && (this._hitElements = u),
                    a = !0
                }
            }
        }
        const c = this._isInteractive(t)
          , p = e.isInteractive();
        return p && p && this._allInteractiveElements.push(e),
        r || this._hitElements.length > 0 ? null : a ? this._hitElements : c && !s(e, i) && n(e, i) ? p ? [e] : [] : null
    }
    hitTestRecursive(e, t, i, n, s) {
        ...
        e.interactiveChildren && e.children) {
            ...
            for (let h = c.length - 1; h >= 0; h--) {
                const l = c[h]
                  , d = this.hitTestRecursive(l, this._isInteractive(t) ? t : l.eventMode, p, n, s);
                if (d) {
                    if (d.length > 0 && !d[d.length - 1].parent)
                        continue;
                    const u = e.isInteractive();
                    return (d.length > 0 || u) && d.push(e),
                    d
                }
            }
        }
        const r = this._isInteractive(t)
          , a = e.isInteractive();
        return r && n(e, i) ? a ? [e] : [] : null
    }
    _isInteractive(e) {
    ...
    hitTestFn(e, t) {
        return e.hitArea ? !0 : e?.containsPoint ? (e.worldTransform.applyInverse(t, P),
        e.containsPoint(P)) : !1
    }
    notifyTarget(e, t) {
    ...
    mapPointerMove(e) {
        ...
        if (n.overTargets?.length > 0 && s !== t.target) {
            const c = e.type === "mousemove" ? "mouseout" : "pointerout"
              , p = this.createPointerEvent(e, c, s);
            if (this.dispatchEvent(p, "pointerout"),
            i && this.dispatchEvent(p, "mouseout"),
        ...
        if (s !== t.target) {
            const c = e.type === "mousemove" ? "mouseover" : "pointerover"
              , p = this.clonePointerEvent(t, c);
            this.dispatchEvent(p, "pointerover"),
            i && this.dispatchEvent(p, "mouseover");
            let h = s?.parent;
        ...
        this.moveOnAll ? r.push("pointermove") : this.dispatchEvent(t, "pointermove"),
        a && r.push("globalpointermove"),
        t.pointerType === "touch" && (this.moveOnAll ? r.splice(1, 0, "touchmove") : this.dispatchEvent(t, "touchmove"),
        a && r.push("globaltouchmove")),
        i && (this.moveOnAll ? r.splice(1, 0, "mousemove") : this.dispatchEvent(t, "mousemove"),
        a && r.push("globalmousemove"),
        this.cursor = t.target?.cursor),
        r.length > 0 && this.all(t, r),
        this._allInteractiveElements.length = 0,
        this._hitElements.length = 0,
    ...
    mapPointerUp(e) {
        ...
        if (r) {
            ...
            if (c.target === a.target && t - c.timeStamp < 200 ? ++c.clickCount : c.clickCount = 1,
            c.target = a.target,
            c.timeStamp = t,
            a.detail = c.clickCount,
            a.pointerType === "mouse") {
                const p = a.button === 2;
...
const fe = 1
  ...
  , B = class x {
    ...
    _onPointerDown(e) {
        ...
        for (let i = 0, n = t.length; i < n; i++) {
            const s = t[i]
              , r = this._bootstrapEvent(this._rootPointerEvent, s);
    ...
    _normalizeToPointerData(e) {
        ...
        if (this.supportsTouchEvents && e instanceof TouchEvent)
            ...
            typeof i.pointerId > "u" && (i.pointerId = fe),
    ...
    _bootstrapEvent(e, t) {
        ...
        e.type.startsWith("touch") && (e.type = ge[e.type] || e.type),
        e
    }
...
const me = {
    ...
    set interactive(o) {
        this.eventMode = o ? "static" : "passive"
    },
    ...
    addEventListener(o, e, t) {
        ...
        s ? c.once(o, a, r) : c.on(o, a, r)
    },
    removeEventListener(o, e, t) {
        const i = typeof t == "boolean" && t || typeof t == "object" && t.capture
