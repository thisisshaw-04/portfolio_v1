import {S as G, E as l, B as A, w as m, D as S, N as W, a5 as xe, x as Te, t as U, u as p, k as j, b as g, Q as M, i as B, j as Ae, l as O, q as K, M as $, a6 as z, a7 as Be, a8 as Ne, a9 as Y, aa as Ie, e as T, A as De, R as ye} from "./hoisted.D2QO1Zsw.js";
import {b as q} from "./colorToUniform.ctgBpyc5.js";
import {e as Ce, G as Ge, c as Ue, b as Oe, U as Pe, R as Fe, B as Z, d as N, f as Me, S as Le, a as He} from "./SharedSystems.DRdb9S1w.js";
class Q {
    constructor() {
        this._didUpload = !1,
        this._tempState = G.for2d()
    }
    init(e) {
    ...
    start(e, r, s) {
        const n = e.renderer;
        n.shader.bind(s, this._didUpload),
...
class J {
    ...
    createGLBuffer(e) {
        ...
        return this._gpuBuffers[e.uid] = n,
...
t))(y || {})
  , te = (t => (t[t.TEXTURE_2D = 3553] = "TEXTURE_2D",
        ...
        for (const s in this._geometryVaoHash) {
            if (e)
                for (const n in this._geometryVaoHash[s]) {
                    ...
                    this._activeVao !== i && this.unbind(),
                    r.deleteVertexArray(i[n])
                }
    ...
    activateVao(e, r) {
        ...
        for (const o in i) {
            ...
            if (h) {
                ...
                const E = W(c.format)
                  , b = ke(c.format);
                if (h.format?.substring(1, 4) === "int" ? s.vertexAttribIPointer(d, E.size, b, c.stride, c.offset) : s.vertexAttribPointer(d, E.size, b, E.normalised, c.stride, c.offset),
                c.instance)
                    if (this.hasInstance) {
                        const ve = c.divisor ?? 1;
                        s.vertexAttribDivisor(d, ve)
                    } else
...
class ie {
    ...
    draw(e) {
        const r = this._renderer
          , {geometry: s, shader: n, state: i, skipSync: a, topology: o, size: c, start: u, instanceCount: _} = e;
        r.shader.bind(n, a),
...
function $e(t) {
    ...
    for (let i = 0; i < e.length; i++) {
        ...
        if (a.data.size > 1 && (r = Math.max(r, 16) * a.data.size),
        a.size = r,
        s % r !== 0 && s < 16) {
            const o = s % r % 16;
            s += o,
...
function ze(t, e) {
    const r = Math.max(oe[t.data.type] / 16, 1)
...
class qe {
    ...
    startRenderPass(e, r=!0, s, n) {
        ...
        (_.x !== n.x || _.y !== c || _.width !== n.width || _.height !== n.height) && (_.x = n.x,
        _.y = c,
        _.width = n.width,
        _.height = n.height,
    ...
    initGpuRenderTarget(e) {
        const r = this._renderer
          , s = r.gl
          , n = new Ke;
        return e.colorTexture.resource === r.canvas ? (this._renderer.context.ensureCanvasSize(e.colorTexture.resource),
        n.framebuffer = null,
    ...
    _resizeColor(e, r) {
        ...
        r.msaa) {
            ...
            e.colorTextures.forEach( (o, c) => {
                ...
                i.framebufferRenderbuffer(i.FRAMEBUFFER, i.COLOR_ATTACHMENT0 + c, i.RENDERBUFFER, d)
            }
            )
        }
    }
    ...
    postrender(e) {
        if (this._renderer.context.multiView && Ae.test(e.colorTexture.resource)) {
    ...
    for (const u in t.groups) {
        ...
        for (const h in _.resources) {
            ...
            if (d instanceof O)
                ...
                const E = t._uniformBindMap[u][h]
                  , b = o.uniformData[E];
                b && (n || (n = !0,
                s.push(`
                        var tS = r.texture;
                        `)),
                e._gl.uniform1i(b.location, a),
                r.push(`
...
`)
      , i = {}
      , a = n.map(u => parseFloat(u.replace(/^ERROR\: 0\:([\d]+)\:.*$/, "$1"))).filter(u => u && !i[u] ? (i[u] = !0,
    !0) : !1)
      , o = [""];
    a.forEach(u => {
        r[u - 1] = `%c${r[u - 1]}%c`,
...
function nt(t, e, r, s) {
    t.getProgramParameter(e, t.LINK_STATUS) || (t.getShaderParameter(r, t.COMPILE_STATUS) || V(t, r),
    t.getShaderParameter(s, t.COMPILE_STATUS) || V(t, s),
    console.error("PixiJS Error: Could not initialize shader."),
    t.getProgramInfoLog(e) !== "" && console.warn("PixiJS Warning: gl.getProgramInfoLog()", t.getProgramInfoLog(e)))
}
function it(t, e) {
    const r = H(t, t.VERTEX_SHADER, e.vertex)
      , s = H(t, t.FRAGMENT_SHADER, e.fragment)
      , n = t.createProgram();
    t.attachShader(n, r),
    t.attachShader(n, s);
    ...
    e._attributeData = tt(n, t, !/^[ \t]*#[ \t]*version[ \t]+300[ \t]+es[ \t]*$/m.test(e.vertex)),
...
class he {
    ...
    bindUniformBlock(e, r, s=0) {
        ...
        if (o === void 0) {
            ...
            a ? n.bindBufferRange(e.buffer, _, e.offset) : n.bindBufferBase(e.buffer, _)
        }
        const c = this._gl
          , u = this._activeProgram._uniformBlockData[r].index;
        i.uniformBlockBindings[s] !== o && (i.uniformBlockBindings[s] = o,
        c.uniformBlockBinding(i.program, u, o))
    }
    _setProgram(e) {
    ...
    _createProgramData(e) {
        const r = e._key;
        return this._programDataHash[r] = it(this._gl, e),
  ...
  , me = {
    ...
    upload(t, e, r, s) {
        ...
        const i = e.width
          ...
          , u = t.resourceWidth
          , _ = t.resourceHeight;
        u < o || _ < c ? ((i !== o || a !== c) && r.texImage2D(e.target, 0, e.internalFormat, o, c, 0, e.format, e.type, null),
        s === 2 ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, u, _, e.format, e.type, t.resource) : r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, e.format, e.type, t.resource)) : i === o || a === c ? r.texSubImage2D(r.TEXTURE_2D, 0, 0, 0, e.format, e.type, t.resource) : s === 2 ? r.texImage2D(e.target, 0, e.internalFormat, o, c, 0, e.format, e.type, t.resource) : r.texImage2D(e.target, 0, e.internalFormat, e.format, e.type, t.resource),
        e.width = o,
        e.height = c
    }
}
...
function X(t, e, r, s, n, i, a, o) {
    ...
    if ((!o || t.magFilter !== "linear") && e[n](c, e.TEXTURE_MAG_FILTER, k[t.magFilter]),
    r) {
        ...
        e[n](c, e.TEXTURE_MIN_FILTER, k[t.minFilter]);
...
class Ee {
    ...
    contextChange(e) {
        this._gl = e,
        this._mapFormatToInternalFormat || (this._mapFormatToInternalFormat = At(e, this._renderer.context.extensions),
        this._mapFormatToType = Bt(e),
        this._mapFormatToFormat = Tt(e)),
        this._glTextures = Object.create(null),
        this._glSamplers = Object.create(null),
        this._boundSamplers = Object.create(null);
        for (let r = 0; r < 16; r++)
    ...
    _initSource(e) {
        ...
        return this._glTextures[e.uid] = s,
    ...
    updateStyle(e, r) {
        ...
        X(e.style, s, e.mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "texParameteri", s.TEXTURE_2D, !this._renderer.context.supports.nonPowOf2wrapping && !e.isPowerOfTwo, r)
    }
    onSourceUnload(e) {
    ...
    onSourceUpdate(e) {
        ...
        this._boundTextures[this._activeTextureLocation] = e,
        this._uploads[e.uploadMethodId] ? this._uploads[e.uploadMethodId].upload(e, s, r, this._renderer.context.webGLVersion) : r.texImage2D(r.TEXTURE_2D, 0, r.RGBA, e.pixelWidth, e.pixelHeight, 0, r.RGBA, r.UNSIGNED_BYTE, null),
    ...
    _initSampler(e) {
        ...
        X(e, r, this._boundTextures[this._activeTextureLocation].mipLevelCount > 1, this._renderer.context.extensions.anisotropicFiltering, "samplerParameteri", s, !1, !0),
    ...
    getPixels(e) {
        const r = e.source.resolution
          ...
          , _ = o.gl;
        return _.bindFramebuffer(_.FRAMEBUFFER, u.resolveTargetFramebuffer),
...
const It = [...Le, ce, je, Ve, J, Ee, ue, re, le, he, ie, Et, ae, ne]
  , Dt = [...He]
  , yt = [Q, Se, be]
  , pe = []
  , ge = []
  , Re = [];
T.handleByNamedList(l.WebGLSystem, pe);
T.handleByNamedList(l.WebGLPipes, ge);
T.handleByNamedList(l.WebGLPipesAdaptor, Re);
T.add(...It, ...Dt, ...yt);
class Ot extends De {
    constructor() {
        const e = {
